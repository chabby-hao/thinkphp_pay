...
;(function(exports){
	var KeyBoard = function(input, options, func1){
		...
		var tableStr = '<table id="' + TABLE_ID + '" border="0" cellspacing="0" cellpadding="0">';
			tableStr += '<tr><td>1</td><td>2</td><td>3</td><td rowspan="2">↼</td></tr>';
			tableStr += '<tr><td>4</td><td>5</td><td>6</td></tr>';
			tableStr += '<tr><td>7</td><td>8</td><td>9</td><td id="pay" style="background-color:rgb(255,83,20);" rowspan="2">确定</td></tr>';
		...
		function addEvent(e){
			...
			if(clickEl.tagName.toLocaleLowerCase() === 'td' && value !== "↼" && value!== "确定"){
				if(self.input){
					self.input.value += value;
				}
				//clickEl.setAttribute("style","background-color:" + backgroundColor);
